    ...
    <section className="mx-auto w-full max-w-6xl px-6 lg:px-8 py-24 sm:py-32 relative overflow-hidden">
      <div className="grid grid-cols-1 gap-x-16 gap-y-16 lg:grid-cols-2 text-center lg:text-left">
        ...
        >
          ...
          <div className="mt-10 space-y-6 w-full max-w-sm">
            <div className="group flex items-start gap-4 cursor-default">
              <div className="flex-none rounded-xl bg-muted p-2.5 transition-colors group-hover:bg-primary/10 group-hover:text-primary">
            ...
            <div className="group flex items-start gap-4 cursor-default">
              ...
              <div className="text-left">
                ...
                <p className="mt-1 text-sm text-muted-foreground">Available Mon-Fri, 9am - 5pm PHT</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <Card className="rounded-[2rem] border border-border/60 bg-background/60 shadow-xs backdrop-blur-sm">
            <CardHeader className="px-6 pt-6 pb-4 sm:px-8">
              <div className="space-y-2">
                ...
                <CardDescription className="text-sm text-muted-foreground">
                  Share your POS goals and we’ll follow up within 24 hours.
                </CardDescription>
              </div>
            </CardHeader>
